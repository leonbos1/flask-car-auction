...
@app.route("/auction/<int:id>/bid", methods=["GET"])
def bid(id):
...
def add_some_data():
    ...
    auction1 = Auction(price=10000, car_id=1, end_date="2020-12-31",
                       location="Amsterdam", longitute=4.895168, latitude=52.370216)
    auction2 = Auction(price=20000, car_id=2, end_date="2020-12-31",
                       location="Rotterdam", longitute=4.47917, latitude=51.9225)
    auction3 = Auction(price=30000, car_id=3, end_date="2020-12-31",
                       location="Utrecht", longitute=5.12142, latitude=52.09083)
    auction4 = Auction(price=40000, car_id=4, end_date="2020-12-31",
